...
<footer class="bg-gray-900 text-gray-300 py-20 mt-20 border-t border-gray-800">
        ...
        <div class="space-y-6">
            ...
            <div class="pt-4 border-t border-gray-800 inline-block">
                ...
                <a href="https://www.vecinoseguro.com" target="_blank"
                    class="text-gray-400 hover:text-white transition-colors font-bold tracking-tight">VS System</a>
            </div>
        </div>
