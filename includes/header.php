            ...
            <div class="max-w-7xl mx-auto px-4 md:px-8 py-4 flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-10 text-[10px] font-black uppercase tracking-[0.2em]">
                    ...
                    <a href="/mayorista.php"
                        class="bg-red-600 text-white font-black px-5 py-2.5 rounded-full hover:bg-white hover:text-red-600 transition-all shadow-lg shadow-red-600/20 hover:scale-105">Venta
                        Mayorista</a>
                </nav>
